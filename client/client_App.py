...
HOST = '172.20.10.9'    # Server(Raspberry Pi) IP address
PORT = 21567
...
def changeSpeed(ev=None):
	...
	print('sendData = {}'.format(data))
	tcpCliSock.send(bytearray(data,'utf-8'))  # Send the speed data to the server(Raspberry Pi)
